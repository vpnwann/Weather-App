...
const Weather = () => {
  ...
  return (
    ...
    <div class="w-full h-[320px] relative flex flex-col justify-center items-center">
        <video class="absolute top-0 left-0 w-full h-80 object-cover" autoplay muted loop>
        ...
        <div class="relative z-10 w-full mx-auto">
            <form>
                <div class="xl:w-1/2 lg:w-[60%] md:w-[70%] sm:w-[70%] xs:w-[90%] mx-auto flex gap-2 md:mt-6 xs:mt-4 mx-4">
                    <input  class="border text-black border-gray-400 w-full p-2 rounded-md text-xl pl-2"
...
{weather ? (
<div class=" max-w-sm m-12 mx-auto  rounded-lg bg-slate-100 text-gray-800 border shadow-md">
	<div class="flex justify-between space-x-8">
		<div class="flex flex-col items-center">
			...
			<h1 class="text-xl font-semibold">{weather.name}</h1>
		</div>
		<span class="font-bold text-6xl mt-12">{weather.main.temp}</span>
	</div>
